...
{
    /**
     * Convert organizer_requests from organization fields (cnpj, etc.) to natural-person fields.
     */
    public function up(): void
    {
        ...
        if (Schema::hasColumn('organizer_requests', 'cpf') && ! Schema::hasColumn('organizer_requests', 'cnpj')) {
            if (! Schema::hasColumn('organizer_requests', 'phone_number')) {
